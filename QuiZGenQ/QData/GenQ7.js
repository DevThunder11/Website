...
export function GenRandomQ7(){
    ...
    const question_text = "ยิงกระสุนขึ้นฟ้า 3 ลูกติดต่อกัน ด้วยอัตราเร็วต้น u เมตรต่อวินาทีเท่ากัน และเว้นช่วงเวลาระหว่างลูกที่ถัดกัน t วินาที กระสุนที่ 2 และ 3 จะสวนกันที่ระยะสูงจากฐานยิงกี่เมตร (ENT จุฬา)".split(" ")
