...
export function GenRandomQ17(){
    ...
    const question_text = "วัตถุก้อนหนึ่งถูกปล่อยให้ตกลงมาในแนวดิ่งพร้อมกับอีกก้อนที่ตกลงมาด้วยความเร็วต้น u m/s วัตถุที่ปล่อยลงมาจะเคลื่อนที่เป็นระยะเท่าไหร่ที่ทำให้วัตถุทั้งสองจึงจะอยู่ห่างกัน 18 เมตร (ไม่คิดผลจากแรงต้านทานการเคลื่อนที่ของอากาศและกำหนดค่าแรงโน้มถ่วง เท่ากับ 10 เมตร/วินาทีกำลังสอง)".split(" ")
