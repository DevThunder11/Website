...
const question_text_Default = "name จุดบั้งไฟขึ้นไปในอากาศด้วยความเร่งคงที่ a เมตรต่อวินาทีกำลังสอง ผ่านไป t วินาทีเชื้อเพลิงหมด บั้งไฟจะอยู่สูงสุดจากจุดปล่อยเป็นระยะกี่เมตร (กำหนดให้ g = 10 เมตรต่อวินาทีกำลังสอง)"
