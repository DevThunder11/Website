...
export function GenRandomQ13(){
    ...
    const question_text = "หินก้อนหนึ่งหลุดลงมาจากยอดตึกสูง h เมตร เมื่อก้อนหินผ่านขอดต้นมะม่วงแล้ว t วินาที ก็ตกถึงพื้นดิน จงหาความสูงของต้นมะม่วง (กำหนดให้ g = 10 เมตรต่อวินาทีกำลังสอง)".split(" ")
