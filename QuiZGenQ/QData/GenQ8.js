...
export function GenRandomQ8(){
    ...
    const question_text = "ในการปรับให้หยดน้ำ หยดจากปลายหลอดบิวเรตต์ชนิดหนึ่ง เมื่อหยดถึงพื้นอีกหยดหนึ่งถัดไปก็หยดทันที เมื่อปลายบิวเรตต์สูง h ซม. หยดน้ำจะหยดได้กี่หยดต่อ t วินาที (กำหนดให้ g = 10 เมตรต่อวินาทีกำลังสอง)".split(" ")
