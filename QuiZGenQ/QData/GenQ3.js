...
const question_text_Default = "name โยนเหรียญขึ้นไปในแนวดิ่ง เหรียญตกถึงพื้นที่อยู่ตำกว่าตำแหน่งมือที่โยนเหรียญเป็นระยะทาง x เมตร ถ้าเหรียญอยู่กลางอากาศเป็นเวลา t วินาที nameโยนเหรียญขึ้นไปด้วยอัตราเร็วเท่าใด (กำหนดให้ g = 10 เมตรต่อวินาทีกำลังสอง)"
