...
export function GenRandomQ21(){
    ...
    const question_text = "ปล่อยก้อนหินลงไปในบ่อลึก x เมตร พบว่าอีก t วินาที ต่อมาได้ยินเสียงก้อน หินกระทบกันบ่อ อัตราเร็วของเสียงที่ให้จากข้อมูลนี้เป็นเท่าใด (กำหนดให้ g = 10 เมตรต่อวินาทีกำลังสอง)".split(" ")
