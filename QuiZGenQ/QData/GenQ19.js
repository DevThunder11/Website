...
export function GenRandomQ19(){
    ...
    const question_text = "กระถางต้นไม้ตกจากดาดฟ้า ตึกแถวลงไป แล้วเคลื่อนที่ผ่านหน้าต่างสูง x เมตร ในเวลา t วินาที ขอบล่างของหน้าต่างนี้ต่ำจากยอดตึกเท่าใด (ไม่คิดผลจากแรงต้านทานการเคลื่อนที่ของอากาศ และ กำหนดให้ g = 10 เมตรต่อวินาทีกำลังสอง)".split(" ")
