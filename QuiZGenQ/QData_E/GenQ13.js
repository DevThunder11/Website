...
export function GenRandomQ13(){
    ...
    const question_text = "วัตถุมวล m กิโลกรัม เคลื่อนที่ลงมาตามพื้นเอียงที่มีความฝืด ณ จุดที่สูงจากพื้น h เมตร วัตถุมีอัตราเร็ว u เมตร/วินาที เมื่อถึงจุดพื้นผิว ยังมีความเร็วเท่าเดิม จงหางานที่เนื่องจากความฝืดระหว่างเส้นทางจะมีค่าเป็นกี่จูล".split(" "); // Question text for Q13
