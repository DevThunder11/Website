...
export function GenRandomQ3(){
    ...
    const question_text = "เด็กคนหนึ่งออกแรง f นิวตัน ลากกล่องไม้ในแนวทำมุม 30 องศาในแนวดิ่ง ถ้าเขาลากกล่องไม้ไปได้ไกล s เมตร ด้วยอัตราเร็วคงที่ จงหางานที่เด็กคนนี้ทำ".split(" ")
