export function explanation(template , question_text){
    ...
    if (template == "Q0") {
        ...
        explanation_text = `จากโจทย์เรารู็ว่า รถเคลื่อนที่ไปทั้งหมด3ช่วง ได้แก่ ช่วงเร่ง คงที่ และ หน่วง โดยจะแบ่งช่วงออกมา ด้วยเวลาตอน เร่งและหน่วงจะเท่ากับ t₁ (เพราะเนื่องจากกว่า ช่วงตรงกลาง
