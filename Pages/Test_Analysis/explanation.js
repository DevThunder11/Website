export function explanation(template , question_text){
    ...
    if (template == "Q0") {
        ...
        explanation_text = `เนื่องจากว่า แรงที่ทำให้วัตถุหล่นลงมามีเพียงแค่ แรงโน้มถ่วงเท่านั้น ทำให้มวลที่แตกต่างกันจะไม่ส่งผลต่อการตกลงมา [หากไม่คำนึงถึงแรงต้านอากาศ]`
